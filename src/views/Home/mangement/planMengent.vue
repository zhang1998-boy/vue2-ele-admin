 ...
 * @Date: 2024-06-18 13:26:27
 * @LastEditors: 张鹏 215683509@qq.com
 * @LastEditTime: 2024-06-19 13:38:22
 * @FilePath: /zt-fill-web/src/views/Home/mangement/dataMengent copy.vue
 * @Description: 运营填报 - 运营计划
-->
<template>
  <div class="table_container">
    <div class="info">
      <div class="rt-title">运营计划</div>
      <div class="info-btn">
    ...
    >
      ...
      >
        <template #default="scope">
          ...
          <span v-else-if="item.prop === 'timeDimensionName'">
            <span>{{
              scope.row['bookYear'] + '-' + scope.row['bookMonth']
            }}</span>
          </span>
...
import { planTableHeader } from '@/utils/tableHeader'
...
export default {
  ...
  methods: {
    ...
    async getResturants() {
      ...
      let { data, retCode } = await getInfoList({}, 'operationalPlan')
      if (retCode === '0') {
        this.tableData = data
      } else {
        this.tableData = []
